...
import com.rafaelsantos.PocBeveragesEcommerce.tests.TokenUtil;
...
public class OrderControllerRA {
    ...
    public void setup() throws JSONException {
        ...
        item1.put("beverageId", 1);
        item1.put("quantity", 2);

        Map<String, Object> item2 = new HashMap<>();
        item2.put("beverageId", 3);
    ...
    public void findByIdShouldReturnOrderWhenIdExistsAndAdminLogged() throws JSONException {
        given()
                ...
                .body("items.name", hasItems("Coca-Cola", "Orange Juice"))
                .body("total", is(6.87F));  // Adjusted total
    }
